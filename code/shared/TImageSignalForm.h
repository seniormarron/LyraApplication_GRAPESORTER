...
#ifndef TImageSignalFormH
#define TImageSignalFormH
...
//forward declaration
class  TImageSignalForm;
class TMyMachineModuleMngr;
class TImageSignalMngr;

struct signalAndIndex           {
   wchar_t signalName[32];
   unsigned int index;
   unsigned int max;
   unsigned int min;
   unsigned int width;
...
/******************************************************************************
                               TImageSignalViewerFormInterface
*******************************************************************************/


//------------------------------------------------------------------------------
  class TImageSignalFormInterface : public TViewInterface{
 public:
   __fastcall TImageSignalFormInterface(TDataManager *mngr, TForm *form);
   virtual ~TImageSignalFormInterface();
...
public:		// User declarations
    __fastcall TImageSignalForm(TComponent* Owner, TDataManager *mn);
    __fastcall ~TImageSignalForm();
...
//---------------------------------------------------------------------------
extern PACKAGE TImageSignalForm *ImageSignalForm;
//---------------------------------------------------------------------------
#endif
