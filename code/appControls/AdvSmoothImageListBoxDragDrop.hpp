...
// (DO NOT EDIT: machine generated header) 'AdvSmoothImageListBoxDragDrop.pas' rev: 22.00
...
extern PACKAGE HRESULT __fastcall StartTextDoDragDrop(TImageListBoxDropSource* DropSource, System::UnicodeString stxt, System::UnicodeString srtf, int dwOKEffects, int &dwEffect);
...
//-- end unit ----------------------------------------------------------------
#endif	// AdvsmoothimagelistboxdragdropHPP
