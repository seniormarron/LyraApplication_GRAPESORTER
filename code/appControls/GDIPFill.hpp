...
// (DO NOT EDIT: machine generated header) 'GDIPFill.pas' rev: 22.00
...
public:
	...
	virtual void __fastcall Assign(Classes::TPersistent* Source);
	void __fastcall Draw(Advgdip::TGPGraphics* g, const Types::TRect &r, double TotalCapacity, TCapacityItems* Items, System::UnicodeString CapacityDes, System::UnicodeString DesFormat, System::UnicodeString FreeDes, System::UnicodeString FreeDesFormat, Advgdip::TAntiAlias AntiAlias);
	Advgdip::TGPRectF __fastcall GetInsideRectF(const Types::TRect &r);
	__property Classes::TNotifyEvent OnChange = {read=FOnChange, write=FOnChange};
