...
// (DO NOT EDIT: machine generated header) 'GDIPPictureContainerEditor.pas' rev: 22.00
...
__published:
	...
	void __fastcall FileListKeyDown(System::TObject* Sender, System::Word &Key, Classes::TShiftState Shift);
