...
// (DO NOT EDIT: machine generated header) 'AdvSmoothEdit.pas' rev: 22.00
...
class PASCALIMPLEMENTATION TAdvSmoothEdit : public Stdctrls::TCustomEdit
{
...
public:
	/* TWinControl.CreateParented */ inline __fastcall TAdvSmoothEdit(HWND ParentWindow) : Stdctrls::TCustomEdit(ParentWindow) { }
...
static const System::ShortInt MIN_VER = 0x8;
static const System::ShortInt REL_VER = 0x5;
static const System::ShortInt BLD_VER = 0x5;
extern PACKAGE System::StaticArray<int, 2> BorderRec;
extern PACKAGE bool AdvSmoothEdit_DEFAULTHANDLING;
extern PACKAGE bool __fastcall AdvInputQuery(const TAdvSmoothEditType QueryType, PQueryParams QueryParams, const System::UnicodeString ACaption, const System::UnicodeString APrompt, System::UnicodeString &Value);
