...
// (DO NOT EDIT: machine generated header) 'AdvSmoothGauge.pas' rev: 22.00
...
struct DECLSPEC_DRECORD TCalibrationValue
{
...
typedef System::DynamicArray<Advgdip::TGPPointF> TArrayOfPointF;
...
private:
	...
	System::StaticArray<TCalibrationValue, 1001> FCalibrationValues;
	bool FDesignTime;
