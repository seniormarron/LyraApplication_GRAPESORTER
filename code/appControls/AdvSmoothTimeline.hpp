...
// (DO NOT EDIT: machine generated header) 'AdvSmoothTimeLine.pas' rev: 22.00
...
public:
	...
	Advgdip::TGPRectF __fastcall GetAnnotationRect(void);
...
typedef System::DynamicArray<TAdvSmoothTimeLineBarSection*> TSortSectionArray;
...
struct DECLSPEC_DRECORD TTimeLineValue
{
...
typedef System::DynamicArray<TTimeLineValue> TTimeLineValueArray;
...
static const System::ShortInt REL_VER = 0x1;
static const System::ShortInt BLD_VER = 0x3;
