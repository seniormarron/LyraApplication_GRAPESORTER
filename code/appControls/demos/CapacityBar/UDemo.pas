...
type
  TForm164 = class(TForm)
    ...
    Label4: TLabel;
    Label5: TLabel;
    procedure AdvSmoothCapacityBar1GetLegendFormat(Sender: TObject;
...
procedure TForm164.AdvSmoothCapacityBar1GetLegendFormat(Sender: TObject;
  Item: TCapacityItem; var Format: string; var Value: Double);
begin
  if Item.Index = 0 then
  begin
    Format := '%.0f Item';
    Value := 63;    // Display value
  end;
