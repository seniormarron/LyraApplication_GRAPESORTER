...
uses
  ...
  ExtCtrls, Math, ImgList, GDIPPictureContainer, jpeg, Dialogs, AdvStyleIF, ShellAPI, ComCtrls;
...
begin
  ...
  begin
    ...
    begin
      ...
      '<font size="8" color="clRed">email address </font><font size="8">is </font><font size="8">' +
