object Form179: TForm179
  ...
  object AdvSmoothTabPager1: TAdvSmoothTabPager
    ...
    object AdvSmoothTabPager12: TAdvSmoothTabPage
      ...
      PageAppearance.BackGroundPicture.Data = {}
      PageAppearance.BackGroundPictureLeft = 0
      PageAppearance.BackGroundPictureTop = 0
      PageAppearance.Picture.Data = {}
      PageAppearance.PictureLeft = 0
      PageAppearance.PictureTop = 0
      PageAppearance.BorderColor = 9841920
      PageAppearance.BorderWidth = 2
      PageAppearance.Rounding = 0
      PageAppearance.ShadowOffset = 0
      PageAppearance.Angle = 0
      ...
      TabAppearance.Status.Appearance.Fill.BackGroundPictureLeft = 0
      TabAppearance.Status.Appearance.Fill.BackGroundPictureTop = 0
      TabAppearance.Status.Appearance.Fill.PictureLeft = 0
      TabAppearance.Status.Appearance.Fill.PictureTop = 0
      ...
      TabAppearance.Status.Appearance.Fill.Angle = 0
    ...
    object AdvSmoothTabPager11: TAdvSmoothTabPage
      ...
      TabAppearance.Status.Appearance.Fill.BackGroundPicture.Data = {}
      TabAppearance.Status.Appearance.Fill.BackGroundPictureLeft = 0
      TabAppearance.Status.Appearance.Fill.BackGroundPictureTop = 0
      TabAppearance.Status.Appearance.Fill.Picture.Data = {}
      TabAppearance.Status.Appearance.Fill.PictureLeft = 0
      TabAppearance.Status.Appearance.Fill.PictureTop = 0
      TabAppearance.Status.Appearance.Fill.OpacityTo = 61
      TabAppearance.Status.Appearance.Fill.BorderColor = clBlack
      TabAppearance.Status.Appearance.Fill.Rounding = 9
      TabAppearance.Status.Appearance.Fill.ShadowOffset = 0
      TabAppearance.Status.Appearance.Fill.Angle = 0
      TabAppearance.Status.Appearance.Font.Charset = DEFAULT_CHARSET
