...
{$ENDIF}
  ...
  TAdvSmoothSlideShow = class(TCustomControl, ITMSStyle)
  private
  ...
  published
    ...
    property FadeAnimationFactor: integer read FFadeAnimationFactor write
...
begin
  ...
  begin
    with Items[i] do
    begin
      if Assigned(Image) and Visible then
      begin
        Inc(cnt);
        ow := Image.Width;
        oh := Image.Height;
