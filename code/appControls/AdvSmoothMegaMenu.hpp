...
// (DO NOT EDIT: machine generated header) 'AdvSmoothMegaMenu.pas' rev: 22.00
...
public:
	...
	#else
	operator Gdipmenu::ITMSMegaMenu*(void) { return (Gdipmenu::ITMSMegaMenu*)&__ITMSMegaMenu; }
	#endif
	#if defined(MANAGED_INTERFACE_OPERATORS)
...
static const System::ShortInt REL_VER = 0x8;
static const System::ShortInt BLD_VER = 0x4;
static const System::Word WM_RECALLFLOATINGFORM = 0x46f;
