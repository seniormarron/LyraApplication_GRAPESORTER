...
// (DO NOT EDIT: machine generated header) 'AdvSmoothCalendar.pas' rev: 22.00
...
public:
	/* TCollection.Create */ inline __fastcall TDisjunctDateTimeArray(Classes::TCollectionItemClass ItemClass) : Classes::TCollection(ItemClass) { }
