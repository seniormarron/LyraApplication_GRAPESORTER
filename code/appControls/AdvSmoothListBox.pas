...
type
  ...
  public
    ...
    function YToDeleteButton(X, Y: integer): integer;
...
begin
  ...
  begin
    ...
    begin
      ...
      Result := Max(1, h div ItemAppearance.Height);
    end;
  end;
end;
        ...
        case Key of
          VK_DOWN, VK_RIGHT:
            begin
              ...
              until (Items[FSelectedItemIndex].Visible) or (FSelectedItemIndex = Items.Count - 1);
          ...
          VK_UP, VK_LEFT:
            begin
              ...
              if (FSelectedItemIndex = 0) and not (Items[FSelectedItemIndex].Visible) then
                FSelectedItemIndex := oldindex;
...
begin
  ...
  begin
    ...
    if md and selitem and (PtInRect(GetDisplayRect, Point(X, Y))) and (Button = mbLeft) then
    begin
      si := ItemAtXY(X, Y);
...
procedure TAdvSmoothListBox.CalculateRects;
var
  o: TAdvSmoothListBox;
  gppointf: TGPPointF;
  crl, crt: Single;
...
var
  tmsif: ISmoothListBox;
begin
  if Assigned(FOwner.DropDownControlClass) then
  begin
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        HTMLDrawGDIP(g, CaptionFont, c , fhtmlrvar, FImages, 0,0,-1,-1,NotesShadowOffset,False,false,false,false,
          False,False,true,1.0,NotesURLColor,clNone,clNone,NotesShadowColor,a,s,k,XSize,YSize,l,m,hr,nil, FContainer,2);
      end
      else
    ...
    begin
      ...
      if UseHTML then
      begin
        HTMLDrawGDIP(g, NotesFont,n, fhtmlrvar,FImages, 0,0,-1,-1,NotesShadowOffset,False,false,false,false,
          False,False,true,1.0,NotesURLColor,clNone,clNone,NotesShadowColor,a,s,k,XSize,YSize,l,m,hr,nil, FContainer,2);
      end
      else
      begin
        f := g.MakeFont(NotesFont);
        sb := TGPSolidBrush.Create(MakeColor(255, NotesFont.Color));
        sf := TGPStringFormat.Create;
...
begin
  ...
  begin
    ...
    begin
      ...
      HTMLDrawGDIP(g, NotesFont, fn,r,FImages, X,Y,-1,-1,NotesShadowOffset,true,false,false,false,
        False,False,true,1.0,NotesURLColor,clNone,clNone,NotesShadowColor,a,s,k,XSize,YSize,l,m,hr,nil, FContainer,2);
...
begin
  ...
  begin
    ...
    FButton.Visible := (not AutoFilter) and Visible;
