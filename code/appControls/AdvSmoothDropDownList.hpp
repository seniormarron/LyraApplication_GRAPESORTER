...
// (DO NOT EDIT: machine generated header) 'AdvSmoothDropDownList.pas' rev: 22.00
...
public:
	...
	#else
	operator Advsmoothlistbox::ISmoothListBox*(void) { return (Advsmoothlistbox::ISmoothListBox*)&__ISmoothListBox; }
	#endif
