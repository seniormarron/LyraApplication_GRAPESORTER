...
// (DO NOT EDIT: machine generated header) 'AdvSmoothDock.pas' rev: 22.00
...
struct DECLSPEC_DRECORD TAnimationPoint
{
...
typedef System::DynamicArray<TAdvSmoothDockItem*> TDockItemArray;
...
struct DECLSPEC_DRECORD TCaptionSize
{
...
struct DECLSPEC_DRECORD TAdvSmoothDockBounds
{
...
private:
	typedef System::DynamicArray<TAnimationPoint> _TAdvSmoothDock__1;
...
static const System::ShortInt DRAGMARGIN = 0x5;
static const System::Word WM_USERACTIVATE = 0x464;
