...
// (DO NOT EDIT: machine generated header) 'AdvSmoothDockDragDrop.pas' rev: 22.00
...
extern PACKAGE HRESULT __fastcall StartTextDoDragDrop(TDockDropSource* DropSource, System::UnicodeString stxt, System::UnicodeString srtf, int dwOKEffects, int &dwEffect);
...
//-- end unit ----------------------------------------------------------------
#endif	// AdvsmoothdockdragdropHPP
