...
// (DO NOT EDIT: machine generated header) 'AdvSmoothTrackBar.pas' rev: 22.00
...
typedef void __fastcall (__closure *TAdvSmoothTrackBarDrawNumber)(System::TObject* Sender, double value, System::UnicodeString &s, bool &AllowDrawText, Graphics::TColor &TickMarkColorLeft, Graphics::TColor &TickMarkColorRight, bool &AllowDrawTickMarkLeft, bool &AllowDrawTickMarkRight);
...
static const System::ShortInt REL_VER = 0x3;
