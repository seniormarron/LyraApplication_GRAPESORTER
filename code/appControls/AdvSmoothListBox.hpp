...
// (DO NOT EDIT: machine generated header) 'AdvSmoothListBox.pas' rev: 22.00
...
private:
	...
	System::UnicodeString FDeleteButtonCaption;
	...
	System::UnicodeString FNodeClosedName;
	System::UnicodeString FNodeOpenName;
	...
	void __fastcall SetNodeClosedName(const System::UnicodeString Value);
	void __fastcall SetNodeOpenName(const System::UnicodeString Value);
...
__published:
	...
	__property System::UnicodeString DeleteButtonCaption = {read=FDeleteButtonCaption, write=FDeleteButtonCaption};
	...
	__property System::UnicodeString NodeOpenName = {read=FNodeOpenName, write=SetNodeOpenName};
	__property Advgdip::TAdvGDIPPicture* NodeClosed = {read=FNodeClosed, write=SetNodeClosed};
	__property System::UnicodeString NodeClosedName = {read=FNodeClosedName, write=SetNodeClosedName};
...
typedef System::DynamicArray<int> TItemSelectArray;
...
private:
	typedef System::DynamicArray<bool> _TAdvSmoothListBoxLookUpBar__1;
	
	
private:
	System::StaticArray<bool, 36> FChar;
...
typedef void __fastcall (__closure *TAdvSmoothListBoxFilterChangeEvent)(System::TObject* Sender, System::UnicodeString &FilterText, bool &AllowFilter);
...
public:
	...
	void __fastcall DoFilterChange(System::TObject* Sender, System::UnicodeString &FilterText, bool &AllowFilter);
...
//-- var, const, procedure ---------------------------------------------------
static const System::ShortInt MAJ_VER = 0x2;
